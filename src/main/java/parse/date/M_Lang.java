...
import static parse.Util.Lang.DEU;
import static parse.Util.Lang.ENG;
import static parse.date.M_Month.M_MONTH_DEU;
import static parse.date.M_Month.M_MONTH_ENG;
import static parse.date.M_Static.*;
import static parse.date.M_Weekday.*;
import static parse.date.Months.MONTHS_STANDARD_DEU;
import static parse.date.Months.MONTHS_STANDARD_ENG;
import static parse.date.Weekdays.WEEKDAYS_STANDARD_DEU;
