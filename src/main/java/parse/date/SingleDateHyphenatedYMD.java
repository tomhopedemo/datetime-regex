...
import static parse.date.HyphenMatchers.M_HYPHENS_UNDERSCORES_DOTS;
import static parse.date.M_Static.MONTHS_ORDER;
import static parse.date.M_Static.M_YEAR_STRONG;
